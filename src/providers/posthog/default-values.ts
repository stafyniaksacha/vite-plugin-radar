import type { PostHogAnalyticsDefaults } from './types'
...
/**
 * Hard-coded PostHog defaults. The loader snippet can be overridden through the
 * plugin options.
 *
 * @see https://posthog.com/docs/libraries/js
 */
export const defaults: Required<PostHogAnalyticsDefaults> = {
  loader,
}
